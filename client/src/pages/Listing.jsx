...
export default function Listing() {
 ...
 { loading  && <p className="text-center my-7 text-2xl">Loading</p>}
  ...
  ( <div>
    ...
    rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer">
      <FaShare className=" text-slate-500" onClick={()=>{
        navigator.clipboard.writeText(window.location.href0);
        setCopied(true);
        setTimeout(()=>{
            setCopied(false);
        },2000);
     ...
     {copied && <p className="flex top-12-[23%] right-[5%] z-10 rounded-md bg-slate-100 p-2"> Link copied !</p>}
